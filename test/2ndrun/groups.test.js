...
//                 return CometChat.createGroup(public_group).should.be.an.instanceof(CometChat.CometChatException);
//             });
...
//                 return CometChat.getGroup(notjoined_public_GUID).should.be.an.instanceof(CometChat.CometChatException);
//             });
...
//                 return CometChat.joinGroup(public_group_to_be_joined, group_type_public).should.be.an.instanceof(CometChat.CometChatException);
//             });
...
//                 return CometChat.leaveGroup(public_group_to_be_left).should.be.an.instanceof(CometChat.CometChatException);
//             });
//         });
...
//                 return CometChat.createGroup(private_group).should.be.an.instanceof(CometChat.CometChatException)
//             });
...
//                 return CometChat.getGroup(notjoined_private_GUID).should.be.an.instanceof(CometChat.CometChatException);
//             });
...
//                 return CometChat.joinGroup(private_group_to_be_joined, group_type_private).should.be.an.instanceof(CometChat.CometChatException);
//             });
...
//                 return CometChat.leaveGroup(private_group_to_be_left).should.be.an.instanceof(CometChat.CometChatException);
//             });
//         });
...
//                 return CometChat.createGroup(password_group).should.be.an.instanceof(CometChat.CometChatException)
//             });
...
//                 return CometChat.getGroup(notjoined_password_GUID).should.be.an.instanceof(CometChat.CometChatException);
//             });
...
//                 return CometChat.joinGroup(password_group_to_be_joined, group_type_password, password).should.be.an.instanceof(CometChat.CometChatException);
//             });
...
//                 return CometChat.leaveGroup(password_group_to_be_left).should.be.an.instanceof(CometChat.CometChatException);
//             });
//         });
//     });
